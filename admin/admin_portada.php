...
<div class="container">
  <div class="row">
    <div class="col-md-12">
      <a href="crear.php"  class="btn btn-success ">Crear rol</a>
      <hr>
		<div class="row">
                <div class="col-lg-12">
                                ...
                                <table class="table table-striped table-bordered table-hover">
									...
									?>
                                        <tr>
                                            ...
                                            <td>*******</td>
											<td width="4%"><a class="btn btn-success" href="actualizar.php?id=<?php echo $row['id'] ?>" name="edit">editar</a></td>
                                            <td width="7%"><a class="btn btn-danger" href="delete.php?id=<?php echo $row['id'] ?>" name="delete">borrar</a></td>
                                        </tr>
									<?php 
									}
									?>
